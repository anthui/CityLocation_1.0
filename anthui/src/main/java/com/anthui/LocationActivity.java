...
public abstract class LocationActivity extends Activity implements OnScrollListener {
    String city;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    ...
                    city = allCity_lists.get(position).getName();
                    //猪界面获取位置
        ...
        resultList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                city = city_result.get(position).getName();
              //  Log.e("msg", "onItemClick: " + "所搜位置" + city);

                Toast.makeText(getApplicationContext(),
                        city , Toast.LENGTH_SHORT)
                        .show();
                startActivity(city);
...
//=========================================================
            ...
            if (viewType == 0) { // 定位
                ...
                hotCity.setOnItemClickListener(new OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        String city = city_hot.get(position).getName();
                        Toast.makeText(getApplicationContext(),
                                city,
                                Toast.LENGTH_SHORT).show();
    ...
    /**重写方法后，可以根据下面的代码，获取城市的首字母大写
     * String firYin = PingYinUtil.converterToFirstSpell(city).substring(0, 1).toUpperCase();
     *
     * */
    public abstract void startActivity(String city) ;
